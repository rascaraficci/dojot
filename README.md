...
CPqD <www.cpqd.com.br> and were licensed under [GPLv3](https://www.gnu.org/licenses/gpl-3.0.html) prior to release 0.5.2. From release 0.5.2 onwards, these services are being licensed under [Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt).
